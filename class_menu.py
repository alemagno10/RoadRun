...
class Menu:
    def __init__(self):
        self.assets= {
        "play": pygame.image.load('img/play4.png'),
        "perso": pygame.image.load('img/botão_personagens.png'),
        "multiplayer": pygame.image.load('img/multi2.png'),
    ...
    def desenha(self,window: pygame.Surface, state):
        """Blit do background e botões + atualização da posição do menu + direcionamento para proxima tela"""   
        window.fill((0,0,0))
